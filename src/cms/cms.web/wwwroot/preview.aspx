...
<script runat="server">
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not Page.IsPostBack Then
            ...
            If Not IsNothing(Session("mainCss")) Then
                Header.Controls.Add(New LiteralControl(Session("mainCss")))
            End If
            
            If Not IsNothing(Session("sectionCss")) Then
                Header.Controls.Add(New LiteralControl(Session("sectionCss")))
            End If
