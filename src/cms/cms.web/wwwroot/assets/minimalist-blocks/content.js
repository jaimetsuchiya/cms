    ...
    'snippets': [
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/-PiOt51.png">' +
						'\n<h3 class="size-16" style="margin-top: 0px; letter-spacing: 2px; font-weight: 400;">COMPANY 01</h3>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/-PiOt52.png">' +
						'\n<h3 class="size-16" style="margin-top: 0px; letter-spacing: 2px; font-weight: 400;">COMPANY 02</h3>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/-PiOt53.png">' +
						'\n<h3 class="size-16" style="margin-top: 0px; letter-spacing: 2px; font-weight: 400;">COMPANY 03</h3>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-barcode-outline-vDstO1.png">' +
						'\n<h3 class="size-16" style="margin-top: 0px; letter-spacing: 2px; font-weight: 400;">COMPANY 04</h3>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
				'</div>'
		},
      
		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<h1 style="letter-spacing: 7px; font-weight: 400;">OUR PARTNERS</h1>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column full">' +
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/social-dropbox-outline-B14OY1.png">' +
							'\n<p style="margin-top: 0px; letter-spacing: 1px;">COMPANY 1</p>' +
							'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ios7-infinite-outline-B14OY2.png">' +
							'\n<p style="margin-top: 0px; letter-spacing: 1px;">COMPANY 2</p>' +
							'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ios7-partlysunny-outline-6rBq91.png">' +
							'\n<p style="margin-top: 0px; letter-spacing: 1px;">COMPANY 3</p>' +
							'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ios7-star-outline-9OUQb4.png">' +
							'\n<p style="margin-top: 0px; letter-spacing: 1px;">COMPANY 4</p>' +
							'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
						'</div>' +
						'<div class="center" style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/social-buffer-outline-Zdp3X5.png">' +
							'\n<p style="margin-top: 0px; letter-spacing: 1px;">COMPANY 5</p>' +
							'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
						'</div>' +
					'</div>' +
				'</div>'
				...
				'<div class="row clearfix">' +
					'<div class="column full center">' +
						'<div style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ef02-1.png">' +
							'\n<p>Company One</p>' +
						'</div>' +
						'<div style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ef02-2.png">' +
							'\n<p>Company Two</p>' +
						'</div>' +
						'<div style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ef02-3.png">' +
							'\n<p>Company Three</p>' +
						'</div>' +
						'<div style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ef02-4.png">' +
							'\n<p>Company Four</p>' +
						'</div>' +
						'<div style="display:inline-block;width:18%">' +
							'<img src="assets/minimalist-blocks/images/ef02-5.png">' +
							'\n<p>Company Five</p>' +
						'</div>' +
					'</div>' +
				'</div>'
...

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/-cjqWs1.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/-hhjT92.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/-5bEh93.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/-li7DW4.png">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				'<div class="row clearfix">' +
					...
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/social-buffer-outline-MoFWC1.png">' +
						'\n<p style="letter-spacing: 1px;">COMPANY ONE</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-partlysunny-outline-MoFWC2.png">' +
						'\n<p style="letter-spacing: 1px;">COMPANY TWO</p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-paperplane-outline-XZbJQ3.png">' +
						'\n<p style="letter-spacing: 1px;">COMPANY THREE</p>' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/ios7-pulse-ZeVdX1.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/ios7-star-outline-flpzJ2.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/ios7-sunny-outline-kRn7i3.png">' +
					'</div>' +
					'<div class="column fourth">' +
						'<img src="assets/minimalist-blocks/images/ios7-barcode-outline-bkBQX4.png">' +
					'</div>' +
				'</div>'
		},

		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/images/ios7-bell-outline-KwjKP1.png">' +
						'\n<p style="margin-top: 0"><b>Company One</b></p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/images/ios7-sunny-outline-9eiTQ2.png">' +
						'\n<p style="margin-top: 0"><b>Company Two</b></p>' +
					'</div>' +
					'<div class="column third center">' +
						'<img src="assets/minimalist-blocks/images/ios7-paperplane-outline-3EBPp3.png">' +
						'\n<p style="margin-top: 0"><b>Company Three</b></p>' +
					'</div>' +
				'</div>'
		},
       
		{
		    ...
		    'html':
				...
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/social-buffer-outline-MoFWC1B.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 01</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-partlysunny-outline-MoFWC2B.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 02</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-paperplane-outline-XZbJQ3B.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 03</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/social-rss-outline-K3Tve1.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 04</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-pulse-bg3t02.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 05</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-heart-outline-PzR3M3.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 06</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/ios7-barcode-outline-xXeTe4.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 07</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
					'<div class="column fourth center">' +
						'<img src="assets/minimalist-blocks/images/social-dropbox-outline-xXeTe5.png">' +
						'\n<p style="letter-spacing: 2px;">COMPANY 08</p>' +
						'\n<p style="border-bottom: 1px solid #000; width: 30px; display: inline-block; margin-top: 0"></p>' +
					'</div>' +
				'</div>'
		},
		...
		/* Social */
		{
		    'thumbnail': 'preview/element-social.png',
		    'category': '120',
		    'noedit': true,
		    'html':
			        '<div class="is-social">' +
		...
		/* Table 
		{
		    ...
		    'html':
			    '<div class="row clearfix">' +
				    '<div class="column full">' +
            	        '<table class="default" style="border-collapse:collapse;width:100%;"><tr><td><br></td><td><br></td></tr><tr><td><br></td><td><br></td></tr></table>' +
				    '</div>' +
			    '</div>'
		},*/
